...
class UpdateContact extends Component
{
    ...
    onSubmitHandler = (event, dispatch, id) =>
    {
        ...
        axios.put(`https://jsonplaceholder.typicode.com/users/${id}`, this.state.contact)
        .then(response => 
        {
            dispatch({type: "UPDATE_CONTACT", value: {...this.state.contact}, id: id});
  ...
  componentDidMount()
  {
      let routerContact = this.props.location.state;
      this.setState({contact: routerContact });
  }
        ...
        {context => (
            <div className="card mb-3">
                ...
                <div className="card-body">
                    <form onSubmit={(event) => this.onSubmitHandler(event, context.dispatch, this.props.location.state.id)} >
